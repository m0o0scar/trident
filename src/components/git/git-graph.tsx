...
export function GitGraph({ commits, onSelectCommit, selectedHash }: { commits: Commit[], onSelectCommit?: (hash: string) => void, selectedHash?: string }) {
                     ...
                     >
                        ...
                        <div className="flex flex-1 gap-4 overflow-hidden pr-4 items-center">
                            <div className="flex-1 truncate flex items-center gap-2">
                                ...
                                <span className={cn("truncate", selectedHash === node.hash ? "font-semibold" : "")}>
                                    {node.message}
                                </span>
                            </div>
