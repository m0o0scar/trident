                    ...
                    >
                      {branchTracking.ahead > 0 && (
                        <span className="flex items-center text-xs">
                          ⬆️{branchTracking.ahead}
                        </span>
                      )}
                      {branchTracking.behind > 0 && (
                        <span className="flex items-center text-xs">
                          ⬇️{branchTracking.behind}
                        </span>
                      )}
                    </span>
                  )}
