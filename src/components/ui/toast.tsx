  ...
  "group pointer-events-auto relative flex w-full flex-col overflow-hidden rounded-lg border p-4 pr-10 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        warning:
          "warning group border-amber-500/50 bg-amber-50 text-amber-900 dark:bg-amber-950 dark:text-amber-100 dark:border-amber-500/30",
      },
    },
    defaultVariants: {
      variant: "default",
...
function ToastClose({
  ...
  return (
    <ToastPrimitive.Close
      className={cn(
        "absolute right-3 top-3 rounded-md p-1.5 text-foreground/50 opacity-60 transition-all hover:opacity-100 hover:text-foreground hover:bg-foreground/10 focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:text-red-200 group-[.destructive]:hover:text-white group-[.destructive]:hover:bg-white/10 group-[.destructive]:focus:ring-red-400",
        className
      )}
      toast-close=""
      {...props}
